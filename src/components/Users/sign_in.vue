                      ...
                      <v-flex v-if="error">
                       ...
                       <v-form v-model="valid" @submit.prevent="onSignin">
                         ...
                         <v-text-field v-model="password" :rules="passwordRules" label="Password" id="password" type="password" required></v-text-field>
                          <v-btn  class="mt-4 yellow-bg" type="submit" :disabled="loading" :loading="loading" large>Sign in<span slot="loader" class="custom-loader"><v-icon light>cached</v-icon></span></v-btn>
                      </v-form>
                  </v-card-text>
                </v-card>
            </v-flex>
